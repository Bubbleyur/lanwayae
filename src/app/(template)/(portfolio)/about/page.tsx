    ...
    <main className="bg-slate-900/40">
      ...
      <section className="w-full border-separator/10 border-b">
        <div className="inner relative flex flex-col items-center gap-8 border-separator/10 border-x px-8 pt-10 pb-8 xl:flex-row">
          ...
          <div className="md:mr-8 xl:max-w-3/5 flex flex-col gap-4">
            <span className="relative">
              <h4 className="font-medium text-xl">hey there, lanwayae's here.</h4>
              <div className="absolute bottom-0 h-4 w-full bg-linear-to-b from-transparent to-background/60" />
            </span>
            <p className="text-sm leading-relaxed md:text-base">
              i started coding by experimenting with node.js and discord bots, tweaking things until they worked the way i imagined. over time, that curiosity turned into a habit of building clean and structured systems. coding became my way to focus, organize ideas, and turn thoughts into something real — where execution matters more than just ideas.
            </p>
          </div>
        </div>
      </section>
