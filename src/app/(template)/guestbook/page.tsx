...
export default function GuestbookPage() {
  ...
  return (
    <main className="bg-gradient-to-b from-background via-amber-50/20 to-background dark:from-slate-950 dark:via-slate-900/30 dark:to-slate-950">
      <div className="border-t border-separator/10">
        <div className="inner relative flex max-w-5xl border-x border-separator/10 bg-white/60 shadow-xl backdrop-blur-lg dark:bg-slate-900/70">
          <div className="hidden flex-col lg:flex">
            <div className="size-8 border-r border-b border-separator/10 sm:size-20" />
            <div className="grow border-r border-separator/10" />
            <div className="size-8 border-t border-r border-separator/10 sm:size-20" />
          </div>
          <div className="flex grow flex-col">
            <div className="flex w-full">
              <div className="size-8 border-r border-b border-separator/10 sm:size-20" />
              <div className="hidden size-8 border-r border-b border-separator/10 sm:size-20 lg:block" />
              <div className="grow border-b border-separator/10" />
              <div className="hidden size-8 border-b border-l border-separator/10 sm:size-20 lg:block" />
              <div className="size-8 border-b border-l border-separator/10 sm:size-20" />
            </div>
            <div className="group relative flex h-48 overflow-hidden rounded-3xl bg-gradient-to-br from-orange-500/25 via-amber-300/20 to-rose-500/20">
              <div className="absolute top-4 left-4 size-16 bg-foreground blur-[10rem] transition-all group-hover:blur-[7rem]" />
              <div className="absolute right-4 bottom-4 size-16 bg-foreground blur-[7rem] transition-all group-hover:blur-[6rem]" />
              <CloudflareImage
                src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExMmNqcHdieDE4ZzN5ZzB1bnFhczlpNnZ1cG44ZmVzN2o0N2E5M2hwYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/lWqD5ymlAKc9UvV3EB/giphy.gif"
                category="assets"
                alt="Lanwayae Guestbook"
                width={1080}
                height={1080}
            ...
            <div className="flex w-full">
              <div className="size-8 border-t border-r border-separator/10 sm:size-20" />
              <div className="hidden size-8 border-t border-r border-separator/10 sm:size-20 lg:block" />
              <div className="grow border-t border-separator/10" />
              <div className="hidden size-8 border-t border-l border-separator/10 sm:size-20 lg:block" />
              <div className="size-8 border-t border-l border-separator/10 sm:size-20" />
            </div>
          </div>
          <div className="hidden flex-col lg:flex">
            <div className="size-8 border-b border-l border-separator/10 sm:size-20" />
            <div className="grow border-l border-separator/10" />
            <div className="size-8 border-t border-l border-separator/10 sm:size-20" />
          </div>
          <PlusSeparator
        ...
        <div className="border-t border-separator/10">
          <div
            ...
            data-lenis-prevent
            className="inner relative flex h-128 max-w-5xl touch-pan-y flex-col overflow-y-auto border-x border-separator/10 bg-white/70 backdrop-blur-lg dark:bg-slate-900/70"
          >
            ...
            {isLoading ? (
              ...
              <div className="relative flex grow flex-col">
                ...
                {(guestbook || []).map((msg) => (
                  <div
                    key={msg.id}
                    className="border-b border-separator/10 last:border-0"
                  >
                    <div className="flex gap-4 px-8 py-3">
                      ...
                      <div className="flex grow flex-col gap-2">
                        ...
                        <p className="whitespace-pre-wrap rounded-b-2xl rounded-tr-2xl bg-amber-50 p-3 text-slate-800 dark:bg-slate-800/80 dark:text-slate-100">
                          {msg.message}
                        </p>
          ...
          <div className="border-y border-dashed border-white/20">
            ...
            <div className="inner relative h-32 max-w-5xl overflow-hidden border-x border-dashed border-white/20 bg-white/70 backdrop-blur-lg dark:bg-slate-900/70">
              ...
              {session?.data?.user ? (
                <div className="flex h-full flex-col gap-2">
                  <textarea
                    className="h-full grow rounded-2xl border border-white/40 bg-white/80 p-4 text-slate-800 outline-none focus:border-amber-400 focus:ring-0 dark:border-slate-800/60 dark:bg-slate-900/80 dark:text-slate-100"
          ...
          {session?.data?.user && (
            <div className="border-b border-dashed border-white/20">
              <div className="inner relative flex max-w-5xl flex-col items-center justify-between gap-4 border-x border-dashed border-white/20 bg-white/70 px-4 py-3 backdrop-blur-lg dark:bg-slate-900/70 md:flex-row">
      ...
      >
        <DialogContent>
          ...
          process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY.includes("...") ? (
            <div className="rounded border border-destructive/20 bg-destructive/5 p-4 text-center text-destructive">
              <p className="font-semibold">
                Turnstile Site Key is missing or invalid.
              </p>
              <p className="text-sm opacity-80">
                Please ensure NEXT_PUBLIC_TURNSTILE_SITE_KEY is set correctly in
                your .env file.
              </p>
            </div>
          ) : (
            <Turnstile
              ...
              onSuccess={async (token) => {
                ...
                await delay(1000);
                const currentMode = isTurnstileDialogVisible;
