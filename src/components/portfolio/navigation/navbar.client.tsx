  ...
  return (
    <header>
      {matchPath(pathname, shadeExcludeItems) ? null : (
        <div
          className="-z-50 absolute top-0 right-0 left-0 mx-auto bg-[radial-gradient(circle_at_18%_20%,rgba(16,185,129,0.14),transparent_40%),radial-gradient(circle_at_82%_15%,rgba(99,102,241,0.16),transparent_40%)]"
