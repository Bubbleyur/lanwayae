  ...
  return (
    <footer className="bg-slate-50 dark:bg-slate-950">
      <section className="w-full border-separator/10 border-t">
        <div className="inner relative grid grid-cols-2 items-start justify-between gap-8 border-separator/10 border-x p-8 sm:grid-cols-3 md:grid-cols-6 divide-y md:divide-y-0 md:divide-x divide-separator/10 dark:divide-separator/10">
          ...
          <div className="flex flex-col gap-2">
            <span className="block font-mono text-xs text-[#555] mb-2">
              01 // NAVIGATION
            </span>
          ...
          <div className="flex flex-col gap-2">
            ...
            <nav className="flex flex-col gap-1 font-medium font-mono text-blue-600 text-foreground-text text-sm *:hover:pl-2 *:hover:text-sys-accent *:hover:underline transition-all dark:text-blue-400">
              {pages.meta.map((page) => (
                <Link
                  key={page.name}
                  href={page.href}
